...
<link rel="stylesheet" href="roundtrip-2.css">
</head>
<body>
...
<style>
	...
	body{
		...
		background-image:url('roundtrip6.jpg');
...
<% 
	...
	{
		session.setAttribute("tid1",request.getParameter("tid1"));
	}	
%>

<!--*******************Header************************************************************************************************************************* -->
	<b>	<div class="title" align="center"><h3>Reservation For Return: <%=session.getAttribute("twodate")%></h3></div></b>
...
<!--*******************Set Variables using HttpSession************************************************************************************************************************* -->
	<% 
		Class.forName("com.mysql.cj.jdbc.Driver");
		java.sql.Connection conn = DriverManager.getConnection(path, "admin", "Keshav100%");
		Statement stmt = conn.createStatement();
   		String sql = "select s.*,r.totalstops, ad.departuretime, ad.arrivaltime, r.traveltime, t.totalseats from RailwayDB.Schedule as s, RailwayDB.arridept as ad, RailwayDB.route as r, RailwayDB.Train as t where s.origin = '"+String.valueOf(session.getAttribute("destination"))+"' and s.destination = '"+String.valueOf(session.getAttribute("origin"))+"' and s.transitline = ad.transitline and s.rid = r.rid and s.tid = t.tid and t.totalseats > 0 order by s.tid"+";";
		...
		{
		 	sql = "select s.*,r.totalstops, ad.departuretime, ad.arrivaltime, r.traveltime, t.totalseats from RailwayDB.Schedule as s, RailwayDB.arridept as ad, RailwayDB.route as r, RailwayDB.Train as t where s.origin = '"+String.valueOf(session.getAttribute("destination"))+"' and s.destination = '"+String.valueOf(session.getAttribute("origin"))+"' and s.transitline = ad.transitline and s.rid = r.rid and s.tid = t.tid and t.totalseats > 0 order by ad.arrivaltime"+";";
		}
		else if(request.getParameter("short").equals("arrivaltimeD"))
		{
		 	sql = "select s.*,r.totalstops, ad.departuretime, ad.arrivaltime, r.traveltime, t.totalseats from RailwayDB.Schedule as s, RailwayDB.arridept as ad, RailwayDB.route as r, RailwayDB.Train as t where s.origin = '"+String.valueOf(session.getAttribute("destination"))+"' and s.destination = '"+String.valueOf(session.getAttribute("origin"))+"' and s.transitline = ad.transitline and s.rid = r.rid and s.tid = t.tid and t.totalseats > 0 order by ad.arrivaltime desc"+";";
		}
		else if(request.getParameter("short").equals("departuretime"))
		{
		 	sql = "select s.*,r.totalstops, ad.departuretime, ad.arrivaltime, r.traveltime, t.totalseats from RailwayDB.Schedule as s, RailwayDB.arridept as ad, RailwayDB.route as r, RailwayDB.Train as t where s.origin = '"+String.valueOf(session.getAttribute("destination"))+"' and s.destination = '"+String.valueOf(session.getAttribute("origin"))+"' and s.transitline = ad.transitline and s.rid = r.rid and s.tid = t.tid and t.totalseats > 0 order by ad.departuretime"+";";
		}
		else if(request.getParameter("short").equals("departuretimeD"))
		{
		 	sql = "select s.*,r.totalstops, ad.departuretime, ad.arrivaltime, r.traveltime, t.totalseats from RailwayDB.Schedule as s, RailwayDB.arridept as ad, RailwayDB.route as r, RailwayDB.Train as t where s.origin = '"+String.valueOf(session.getAttribute("destination"))+"' and s.destination = '"+String.valueOf(session.getAttribute("origin"))+"' and s.transitline = ad.transitline and s.rid = r.rid and s.tid = t.tid and t.totalseats > 0 order by ad.departuretime desc"+";";
		}
		else if(request.getParameter("short").equals("origin"))
		{
		 	sql = "select s.*,r.totalstops, ad.departuretime, ad.arrivaltime, r.traveltime, t.totalseats from RailwayDB.Schedule as s, RailwayDB.arridept as ad, RailwayDB.route as r, RailwayDB.Train as t where s.origin = '"+String.valueOf(session.getAttribute("destination"))+"' and s.destination = '"+String.valueOf(session.getAttribute("origin"))+"' and s.transitline = ad.transitline and s.rid = r.rid and s.tid = t.tid and t.totalseats > 0 order by s.origin"+";";
		}
		...
		{
		 	sql = "select s.*,r.totalstops, ad.departuretime, ad.arrivaltime, r.traveltime, t.totalseats from RailwayDB.Schedule as s, RailwayDB.arridept as ad, RailwayDB.route as r, RailwayDB.Train as t where s.origin = '"+String.valueOf(session.getAttribute("destination"))+"' and s.destination = '"+String.valueOf(session.getAttribute("origin"))+"' and s.transitline = ad.transitline and s.rid = r.rid and s.tid = t.tid and t.totalseats > 0 order by s.destination"+";";
		}
		else if(request.getParameter("short").equals("destinationD"))
		{
		 	sql = "select s.*,r.totalstops, ad.departuretime, ad.arrivaltime, r.traveltime, t.totalseats from RailwayDB.Schedule as s, RailwayDB.arridept as ad, RailwayDB.route as r, RailwayDB.Train as t where s.origin = '"+String.valueOf(session.getAttribute("destination"))+"' and s.destination = '"+String.valueOf(session.getAttribute("origin"))+"' and s.transitline = ad.transitline and s.rid = r.rid and s.tid = t.tid and t.totalseats > 0 order by s.destination desc"+";";
		}
		else if(request.getParameter("short").equals("stops"))
		{
		 	sql = "select s.*,r.totalstops, ad.departuretime, ad.arrivaltime, r.traveltime, t.totalseats from RailwayDB.Schedule as s, RailwayDB.arridept as ad, RailwayDB.route as r, RailwayDB.Train as t where s.origin = '"+String.valueOf(session.getAttribute("destination"))+"' and s.destination = '"+String.valueOf(session.getAttribute("origin"))+"' and s.transitline = ad.transitline and s.rid = r.rid and s.tid = t.tid and t.totalseats > 0 order by r.totalstops"+";";
		}
		else if(request.getParameter("short").equals("stopsD"))
		{
		 	sql = "select s.*,r.totalstops, ad.departuretime, ad.arrivaltime, r.traveltime, t.totalseats from RailwayDB.Schedule as s, RailwayDB.arridept as ad, RailwayDB.route as r, RailwayDB.Train as t where s.origin = '"+String.valueOf(session.getAttribute("destination"))+"' and s.destination = '"+String.valueOf(session.getAttribute("origin"))+"' and s.transitline = ad.transitline and s.rid = r.rid and s.tid = t.tid and t.totalseats > 0 order by r.totalstops desc"+";";
		}
	...
	<table  class="table">
   	...
   	<%
   		while(rows.next())
   		{
   			...
   			<tr>
   			  <td>
                  <input required type="radio" name="tid2" value="<%= rows.getString("tid") %>">
   			  </td>
   			  <td>
   			 ...
   			 <td>
   			 		<div align="center" class="tableview" ><a href="RoundTrip2.jsp?idd=<%=rows.getString("rid")%>">Stops</a></div>				  	
   			 </td>
...
<!--*******************Submitting Table************************************************************************************************************************* --> 
		<br><input type="submit"class="submit-btn" value="Submit" name="submit2">
	</form>
